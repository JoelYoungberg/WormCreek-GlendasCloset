...
or die('Error querying props database');
...
if ($numResultRowsCost > 0){
  ...
  header("Location: prop_input.php");
  exit();
}
...
$query = "INSERT INTO props (item_num, item_name, picture, descr, color, loc, status, price, status_word)" .
"VALUES ('$item_num', '$item_name', '$fileDestination', '$descr', '$color', '$loc', '$status', '$price', '$status_word')";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['save'])) {
        ...
        header("Location: ../Props/prop_input.php");
    }
}
