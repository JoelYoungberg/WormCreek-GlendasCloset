...
function notify() {//This function does the delete confirmation dialog
	...
	if ($check == true) {
		...
		document.getElementById('ChangeUrl').href = "OpenOrdersSearchForm.php";
	}
}
</script>
...
<!--Open Order Search Box -->
<div class="float-panel">
<form class="formfix" action="orderSearch.php" method="POST">
    <div class="searchBGcolor">
      <input class="searchbarshift" type="text" name="search" size="60px" placeholder="Open Order Search">   
	  	</div> 
