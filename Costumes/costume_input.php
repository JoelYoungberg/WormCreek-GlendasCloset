...
<img class="TitleBarPic" src="../Images/Site/TitleCost.png">


<div class="lighten">
<br>

<form method="post" action="costumeConnect.php" enctype="multipart/form-data">
...
<input type="text" id="gender" name="gender" size="24.3"></div>

<div class="float"><div class="size"><label for="size">Item Size: </label></div>
<input type="text" id="size" name="size"  size="24.3"></div>

<div class="float"><div class="item_color"><label for="color">Item Color: </label></div>
<input type="text" id="color" name="color"  size="25"></div>
<br>
