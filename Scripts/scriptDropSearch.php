...
<?php
  ...
  $query = "UPDATE scripts
    ...
    session_start();//Starting session to store id in order to find page position on return from search
    $_SESSION['id'] = $id;
    ...
    header("Location: scriptSearchSave.php");
