...
//Displaying list of costume results
        $sql = "SELECT * FROM scripts WHERE item_num ='$item_num'";
        ...
        if ($queryResults > 0) {
			while ($row = mysqli_fetch_assoc($result)){
                ...
                <!--Outputting edit form with pre-filled values for selected script=================-->
				
                <img src='../Images/Site/EditScript.png'>
...
<form method='post' action='scriptUpdate.php' enctype='multipart/form-data'>
