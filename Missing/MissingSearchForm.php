...
<script>
function notifyA() {//This function does the delete confirmation dialog
	var $check = confirm('Are you sure you want to change the status of this item to Available? \n Warning: Once you press OK you cannot undo this action...');
	
	if ($check == true) {
		//alert('Costume Deleted'); Do Nothing
	} else {
		document.getElementById('ChangeUrl').href = "MissingSearchForm.php";
	}
}
</script>

<script>
function notifyC() {//This function does the delete confirmation dialog
	var $check = confirm('Are you sure you want to change the status of this item to Cleaning? \n Warning: Once you press OK you cannot undo this action...');
...
<script>
function notifyM() {//This function does the delete confirmation dialog
	var $check = confirm('Are you sure you want to change the status of this item to Mending? \n Warning: Once you press OK you cannot undo this action...');
...
<script>
function notifyD() {//This function does the delete confirmation dialog
	var $check = confirm('Are you sure you want to Delete this item? This will also delete the item from inventory! \n Warning: Once you press OK you cannot undo this action...');
