...
ob_start();
        ...
        //Note: we need to add the Order Processor here (clerk) which was pulled above from orders table so that we can have both order processor clerk and return clerk
         ...
         //Check Which Button was pressed here: Return order or Clean/Mend Return
         if(isset($_POST['cmReturn'])){
        ...
        for ($i = 0; $i < count($skuArray); $i++){
         ...
         //Go back to returns and exit here
         $uid = $_SESSION['u_id'];
        ...
        $_SESSION['u_id'] = $uid; //Keeping user logged in
         ...
         header("Location: ../OpenOrders/OpenOrdersSearchForm.php?return='success'");
         exit();

         ob_end_flush();
         ///////////////////////////////////////////////////////////////End IF cmReturn Pressed///////////////////////////////////////////
